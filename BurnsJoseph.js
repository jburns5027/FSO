...
// JSON Data Below.
var raceInfo = function (json) {
    for (var i = 0; i < json.races.length; i++) {
        var race = json.races[i];
        console.log("Race Name: " + race.name + ", Race Number: " + race.number + ", Distance: " + race.distance + ", Location: " + race.location + ".");
    }
}
...
var bodyMuscles = {
    upper: ["shoulders", "biceps", "triceps"],
    core: ["abdomen", "side abs", "back"],
    lower: ["thighs", "calves", "hamstrings"],
...
// boolean functions.
var outSideClothes = {
    shirt: ["short Sleeve", "dry fit material", "white"],
    legwear: ["shorts", "light cotton", "blue"],
...
var equipment = {
    ...
    workOutOneArea: function (workOut, minutesThisWorkOut) {
        ...
        console.log("Starting to work out the" + workOut + " for " + minutesThisWorkOut + " minutes. ");
